...
export default function EducationForm({ value, onChange, editing, setEditing }) {
  
  // 💡 Helper to update a single field in an entry
  function update(id, name, newValue) {
    onChange((prev) =>
  ...
  return (
    <div className="mb-4">
      ...
      <div className="mt-3 flex gap-2">
        <button type="button" onClick={addEntry} className="px-3 py-1 border rounded">
          + Add Education
        </button>
        <button
          type="button"
